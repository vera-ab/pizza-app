...
class Order(models.Model):
    ...
    pizza = models.ForeignKey("Pizza", verbose_name=_("Order pizza"), blank=False, null=False,
                              related_name="sale_product", on_delete=models.PROTECT)
    price = models.FloatField(verbose_name=_("Price"), blank=True, null=False, default=50.0)
    phone_number = models.CharField(null=False, blank=False, unique=True, help_text='Contact phone number',
                                    max_length=20)
